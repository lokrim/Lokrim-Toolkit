    ...
    return (
        <div className="flex h-screen w-full bg-white dark:bg-zinc-950 font-sans text-zinc-900 dark:text-zinc-50 overflow-hidden">
            ...
            <aside className="w-64 border-r border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/50 flex flex-col hidden md:flex">
                ...
                <div className="flex flex-col space-y-1 p-3 border-t border-zinc-200 dark:border-zinc-800 text-xs text-zinc-500 dark:text-zinc-400">
                    <ThemeToggle />
                    <SettingsModal />
                    <div className="px-2.5 pt-3 pb-1">Personal utilities &copy; {new Date().getFullYear()}</div>
                </div>
            </aside>

            {/* Main Content Area */}
            <main className="flex-1 flex flex-col h-full min-w-0 overflow-hidden bg-white dark:bg-zinc-950">
